...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { descripcion: @compra.descripcion, fechaLote: @compra.fechaLote, idCompra: @compra.idCompra, nombre: @compra.nombre, precio: @compra.precio } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { descripcion: @compra.descripcion, fechaLote: @compra.fechaLote, idCompra: @compra.idCompra, nombre: @compra.nombre, precio: @compra.precio } }
